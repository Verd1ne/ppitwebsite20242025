...
export default async function ParticipantPage({ params }) {
	...
	try {
		...
		if (data.error) {
			return (
				<div
					className={`min-h-screen bg-gray-100 flex items-center justify-center p-4 ${montserrat.variable}`}
				>
		...
		return (
			<div
				className={`min-h-screen bg-gray-100 flex items-center justify-center p-4 ${montserrat.variable} ${legend.variable}`}
			>
